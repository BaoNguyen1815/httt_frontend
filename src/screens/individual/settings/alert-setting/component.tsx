...
class AlertControls extends Component<any, any & any> {
  ...
  componentDidMount() {
    ...
    this.props.alertAction(this.props.userInfo.user_id);
  }

  // async componentDidUpdate(prevProps, prevState) {
  //   if (prevProps.alertDetails !== undefined && prevProps.alertDetails.block_login_new_ip_email === prevState.switch1) {
  //     console.log("componentDidUpdate");
  //     const { alertDetails } = prevProps;
  //     const switch1 = alertDetails.block_login_new_ip_email;
  //     const switch2 = alertDetails.block_push_notifications;
  //     this.setState({
  //       ...this.state,
  //       switch1,
  //       switch2
