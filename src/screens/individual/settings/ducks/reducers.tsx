...
import { getProfileAction, editUserAction, setUserSecurityAction, setAlertAction, setUserAlertsHistory, setUserSessionHistory } from "./actions";

export default handleActions<any>(
  {
    [getProfileAction.toString()]: (state, { payload }) => ({ ...state, userDetail: payload }),
